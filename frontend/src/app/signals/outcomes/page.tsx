  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-4 py-6 text-slate-100">
      ...
      <header className="mb-5">
        ...
        <h1 className="mt-1 text-2xl font-semibold">結果分析與人工檢查</h1>
      ...
      {loading && <p className="text-sm text-slate-500">正在載入 Day10 指標、趨勢、明細與觀察分析…</p>}
      ...
      {summary && (
        <>
          ...
          <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <OutcomeMetricCard label="Acceptable Rate" value={formatRate(summary.recommendation.acceptable_rate)} detail={`Winner ${summary.recommendation.winner_count} + 中性 ${summary.recommendation.neutral_count}／成熟 ${summary.sample.matured}・目標 80%`} status={summary.sample.matured ? summary.recommendation.acceptable_target_met ? "met" : "not-met" : "neutral"} />
